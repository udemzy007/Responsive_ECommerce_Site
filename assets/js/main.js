...
function scrollHeader () {
    ...
    // When the scroll is greater than 50 viewpoint height, add the .scroll-header class (CSS) to the header tag
...
function scrollUp () {
    ...
    //when the scroll is higher than 50 viewport height, add the show scroll class to a tag with the scroll top class
...
/*=============== QUESTIONS ACCORDION ===============*/
// accordion-open - declared in the CSS
